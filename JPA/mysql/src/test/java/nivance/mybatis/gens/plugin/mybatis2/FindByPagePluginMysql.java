...
public class FindByPagePluginMysql extends PluginAdapter {

	public FindByPagePluginMysql() {
        super();
	}
	...
	public boolean modelExampleClassGenerated(TopLevelClass topLevelClass,
		...
		field.setType(FullyQualifiedJavaType.getIntInstance().getPrimitiveTypeWrapper());
		...
		method.addParameter(new Parameter(FullyQualifiedJavaType.getIntInstance().getPrimitiveTypeWrapper(), "startRow"));
		...
		method.setVisibility(JavaVisibility.PUBLIC);
		method.setReturnType(FullyQualifiedJavaType.getIntInstance().getPrimitiveTypeWrapper());
		...
		method.setVisibility(JavaVisibility.PUBLIC);
		method.addParameter(new Parameter(FullyQualifiedJavaType.getIntInstance().getPrimitiveTypeWrapper(), "pageSize"));
		method.setReturnType(null);
		...
		for(Method mod:methods){
			if(mod.getName().equals("clear")){
				...
				mod.addBodyLine("this.pageSize=null;");
...
//		topLevelClass.addImportedType("java.io.Serializable");
	...
	public boolean clientGenerated(Interface interfaze,
		...
		method.addBodyLine("return this.findByPage(example, startRow, pageSize, null);");
		...
		/*
		 * public List<Time> findByPage(Time item,Integer startRow,Integer pageSize, String orderByClause){
	    ...
	    method.setReturnType(fqjt);
	    method.addBodyLine("	example.setStartRow(startRow);");
...
//		}
		interfaze.addSuperInterface(new FullyQualifiedJavaType("SqlDaoSupport<"+ pojo + ","+example+","+introspectedTable.getPrimaryKeyType()+">"));
		...
		for (Method m : methods) {
			m.addException(new FullyQualifiedJavaType("JPAException"));
			if(m.getName().equals("countByExample")){
//				if(example==null){example = new AccAccountExample();}
				m.addBodyLine(0,"if(example==null){example = new "+introspectedTable.getExampleType()+"();}");
			}
		}
	...
	public boolean sqlMapDocumentGenerated(Document document,
		...
		//mysqltemplate
		String template = 
				"<select id=\"findByPage\" resultMap=\"FINDRESULT\" parameterClass=\""+introspectedTable.getExampleType()+"\" remapResults=\"true\" >\r\n" +
				  "	<!--\r\n" +
  				  "	WARNING - @generated\r\n" +
  				  "	This element is automatically generated by MyBatis Generator, do not modify.\r\n" +
  				  "	This element was generated on "+df.format(new Date())+".\r\n" +
  				  "	-->\r\n" +
  				  "<![CDATA[ select a.* from FINDTABLE a]]>" +
...
*/
	...
	public boolean sqlMapSelectByExampleWithoutBLOBsElementGenerated(
		...
		element.addElement(size, pagetail);
		return true;
	}
